...
export function DashboardHeader({ t }: DashboardHeaderProps) {
  return (
    <div className="flex justify-between items-end mb-4">
      <div>
        <h2 className="text-2xl font-black text-primary tracking-tight">Expert Transit Overview</h2>
        <p className="text-outline text-xs font-medium">Addis Ababa Metropolitan Area • Live Fleet Status</p>
      </div>
